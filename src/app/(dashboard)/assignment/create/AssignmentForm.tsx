    ...
    return (
        <>
            <Paper sx={{ p: 2, height: "100%" }} elevation={0} >
                <Typography variant='h6' sx={{ color: "primary.main", mb: 2 }}>Create Assignment</Typography>
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <MuiDatePicker
                                        ...
                                        minDate={moment(watch('startDate')).add(1, "day")}
                                        format="DD/MM/YYYY"
                                    />
                                )}
                            />
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <FormControl {...field}>
                                        ...
                                        <RadioGroup
                                            row
                                            aria-labelledby="assignment-type"
                                            name="examType"
                                        >
                                            <FormControlLabel name="examType" value={1} control={<Radio />} label="Objective" />
                                            <FormControlLabel name="examType" value={2} control={<Radio />} label="Subjective" />

                                        </RadioGroup>
                                        <FormHelperText sx={{ color: "#d32f2f" }}>{errors.examType?.message}</FormHelperText>
                                    </FormControl>
                                )}
                            />
                        </Grid>
