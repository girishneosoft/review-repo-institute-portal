...
import { Button, Box, Grid, IconButton, MenuItem, Avatar, Container } from '@mui/material';
...
export default function Page() {
    ...
    const onSubmit = (data: any) => {
        ...
        setIsLoading(true)
        axiosInstance.post("/api/transport_team/create", formData)
            .then((res) => {
                setIsLoading(false)
                toastMessage(res.data.message, "s")
                router.push('/transport/team-members');
            }).catch(() => {
                setIsLoading(false)
            })
    }
        ...
        <>
            <Container>
                ...
                <Paper sx={{ p: 2, height: "100%" }} elevation={0} >
                    <Typography variant='h6' sx={{ color: "primary.main", mb: 2 }}>Add transport team member</Typography>
